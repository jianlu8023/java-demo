package com.github.jianlu8023.grpc.grpcclient.util;
...
public class InterUtils {
    ...
    private static String getLocalMACList() throws Exception {
        ...
        if (sb.length() <= 1) { throw new Exception("Failed to get local MAC address"); }
    ...
    public static class RealInter {
        ...
        private String md5HashCode32(InputStream fis) throws Exception {
    ...
    public static RealInter getRealInter() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        RealInter realInter = getRealInter();
        System.out.println(getRealInter());
